...
/**
 * MediaSave — save a generated MediaArtifact as a vault entry at a chosen
 * folder. Mirrors ChatActions' destination-folder picker pattern.
 */
export function MediaSave({ artifact }: { artifact: MediaArtifact }) {
  ...
  const defaultTitle = artifact.title || `Generated ${artifact.kind}`;
